...
public class PawnController : EntityComponent<Pawn>
{
	...
	public void Simulate( IClient cl )
	{
		...
		{
			Entity.Velocity = Accelerate( Entity.Velocity, moveVector.Normal, moveVector.Length, 200, 5f );
	...
	Entity CheckForGround()
	{
		...
		if ( Entity.Velocity.z > 1f )
			return null;

		var trace = Entity.TraceBBox( Entity.Position, Entity.Position + Vector3.Down, 0.5f );
